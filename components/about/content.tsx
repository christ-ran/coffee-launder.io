...
export default function Content() {
  return (
    <div className="xs:py-[8vh] lg:py-[15vh] grid xs:grid-cols-1 lg:grid-cols-2 xs:gap-10 lg:gap-0">
      <div className="grid grid-rows-2">
        ...
        <div className="flex flex-col justify-between">
          ...
          <h6 className="font-narrow-emberly xs:text-[3.6vw] lg:text-[1.2vw] text-light-500">
            Junior Software Engineer with strong ownership and robust technical
            skills,
            <br />
            strives to bring the impact contributions and values to the product.
          </h6>
        </div>
      </div>
      <div className="grid grid-rows-2">
